   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Import Data Siskeudes</h1>
        <p></p>
      </div>
      </div>
      </div>
      ...
      <div class="row">
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
               <form action="tambah_aksi_keuangan_import_data.php" method="post" enctype="multipart/form-data">
             <div class="form-group">
                <label for="inputDescription">Judul Berkas</label>
                <input type="hidden" name="id">
                <input type="text" name="judul" id="judul" class="form-control" rows="" placeholder="">
              </div>
               <div class="form-group">
                <label for="inputDescription">Berkas Database Siskeudes</label>
                <input type="file" name="berkas" id="berkas" class="form-control" rows="" placeholder="">
             ...
             <button type="button" class="btn btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown">
                <span class="sr-only">Toggle Dropdown</span>
                   ...
                   <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="keuangan_input_data.php">Input Data</a>
          ...
          <div class="col-sm-6">
              ...
              <div class="table-responsive">
                ...
                <thead>
                  ...
                  include 'koneksi.php';
                  $no = 1;
                  $data = mysqli_query($koneksi,"select * from tb_berkas");
                  while($d = mysqli_fetch_array($data)){ ?>
                    <tr>

                <td><?php echo $no++ ?></td>
                 <td>
        <a href="hapus_berkas.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
