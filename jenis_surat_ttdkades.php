   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Cetak Surat/Jenis Surat Dengan TTD Kades</h1>
        <p>Jenis Surat Pengantar Desa Mandalahaji</p>
      </div>
      <body>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="tambah_aksi_jenis_surat.php" method="post" enctype="multipart/form-data">
               <div class="form-group">
                <label for="inputDescription">Jenis Surat</label>
                <input type="hidden" name="id">
                <input type="text" name="jenis_surat" id="jenis_surat" class="form-control" rows="" placeholder="Tambahkan Surat">
          ...
          <div class="col-sm-6">
              ...
              <div class="table-responsive">
                ...
                <thead>
                  ...
                  $data = mysqli_query($koneksi,"select * from tb_jenis_surat_ttdkades");
                  while($d = mysqli_fetch_array($data)){ ?>
                    <tr>
                <td><?php echo $no++ ?></td>
                <td><?php echo $d['jenis_surat']?></td>
                  <td>
        <a href="#.php?id=<?php echo md5($d['id']); ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="#.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger"><i class="fas fa-trash"></i></a></td>   
               </td>
               <td>
                 <a href="<?php echo $d['link']; ?>" class = "btn btn-warning">Buat Surat</a></td> <?php }?>
               </td>
                </tr>
