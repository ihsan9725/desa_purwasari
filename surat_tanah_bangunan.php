        ...
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form action="cetak_surat_tanah_bangunan.php" method="post" action="tambah_aksi_arsip.php" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <input type="hidden" name="jenis_surat" value="Surat Tanah Bangunan">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="inputDescription" class="btn-primary">DETAIL INFORMASI TANAH/LAHAN</label>  
              </div>
               <div class="form-group">
                <label for="inputDescription">Jenis Tanah</label>
                <select class="form-control" name="jenis_tanah">
                <option selected="selected">JENIS TANAH</option>
                <option>Tanah Sawah</option>
                <option>Tanah Bangunan</option>
                <option>Tanah Darat</option> 
                </select> 
              </div>
               <div class="form-group">
                <label for="inputDescription">Luas Tanah</label>
                <input type="text" name="luas_tanah" class="form-control" placeholder="Masukan Luas Tanah..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Bukti Kepemilikan</label>
                <select class="form-control" name="bukti_kepemilikan">
                  <option selected="selected">BUKTI KEPEMILIKAN</option>
                  <option>Petok Lama</option>
                  <option>Petok Baru</option>
                  <option>Sit Segel</option>
                  <option>Akta</option>
                  <option>Copy</option>
                  <option>Buku Krawangan Desa</option>
                  <option>Lainnya</option>
                </select>   
              </div>
                <div class="form-group">
                <label for="inputDescription">No Bukti Kepemilikan</label>
                <input type="text" name="nomor_kepemilikan" class="form-control" placeholder="Masukan No Bukti Kepemilikan..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Atas Nama</label>
                <input type="text" name="atas_nama" class="form-control" placeholder="Masukan Atas Nama..">  
              </div>
               <div class="form-group">
                <label for="inputDescription">Asal Kepemilikan Tanah</label>
                <select class="form-control" name="asal_tanah">
                  <option selected="selected">ASAL KEPEMILIKAN TANAH</option>
               ...
               <div class="form-group">
                <label for="inputDescription">Bukti Pendukung Kepemilikan</label>
                <input type="text" name="bukti_pendukung" class="form-control" placeholder="Masukan Bukti Pendukung Kepemilikan..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Batas Sebelah Utara</label>
                <input type="text" name="utara" class="form-control" placeholder="Batas Sebelah Utara..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Batas Sebelah Timur</label>
                <input type="text" name="timur" class="form-control" placeholder="Batas Sebelah Timur..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Batas Sebelah Selatan</label>
                <input type="text" name="selatan" class="form-control" placeholder="Batas Sebelah Selatan..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Batas Sebelah Barat</label>
                <input type="text" name="barat" class="form-control" placeholder="Batas Sebelah Barat..">   
              </div>
               <div class="form-group">
                <label for="inputDescription" class="btn-primary">PENANDATANGANAN</label>  
              </div>
              <div class="form-group">
                <label for="inputDescription">Tertanda Atas Nama</label>
                <select class="form-control" name="atas_nama_staf">
