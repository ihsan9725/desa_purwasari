          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Jenis Pelayanan</h5>
              </div>
              <div class="card-body">
               ...
               <!-- tampilkan data tabel -->
                ...
                <div class="card mb-5">
          <div class="card-header">
            <div class="card-title"> <a href="tambah_pelayanan.php" class="btn btn-primary">Tambah Pelayanan</a></div>
          <div class="col-sm-6">
          </div>
        </div>
              ...
              <div class="table-responsive">
                ...
                <td><?php echo $d['pra3'] ?></td>
                  <td>
        <a href="edit_pelayanan.php?id=<?php echo $d['id']; ?>"class = "btn btn-primary"><i class="fas fa-edit"></i></a>
                    </td>
                    <td>
        <a href="hapus_pelayanan.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
