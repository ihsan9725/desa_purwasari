...
<div class="wrapper">
  ...
  while ($row = $result->fetch_assoc()) { 
        ...
        ?></p>
          ...
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Detail Pengajuan Surat Yang Belum Di Tanda Tangani !</b></h5><br>
                 <h6 class="card-title">Halaman ini memuat data pengajuan surat masyarakat Desa Mandalahaji yang belum ditanda tangani.</h6><br>
          ...
          include "koneksi.php";
          $sql="SELECT * FROM tb_surat WHERE status_ttd_kades ='Belum di Tanda tangan!'";
          $no=1;
        ...
        ?>
                ...
                <td>
        <a href="ttd_kades.php?id_surat=<?php echo $d['id_surat']; ?>" class = "btn btn-warning">TTD Online</a><br>
       <br><a href="ttd_kades_ada.php?id_surat=<?php echo $d['id_surat']; ?>" class = "btn btn-warning">Ada dikantor</a>
          </td><?php }?>
