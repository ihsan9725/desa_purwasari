  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Data Staf</h1>
        <p>Halaman Ini Digunakan Untuk Edit Data Staf Desa Mandalahaji</p>
      </div>
      <body>
...
include "koneksi.php";
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM tb_staf WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query)){
  ?>
               <form action="update_staf.php" method="post" enctype="multipart/form-data">
               <div class="form-group">
                <label for="inputDescription">Foto</label>
                <input type="hidden" name="id" value="<?php echo $d['id']?>">
                <img src="img/<?php echo $d['foto']?>" weight="50dp" width="50dp">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Bidang</label>  
                <input type="text" name="bidang" id="" class="form-control" rows="" placeholder="Masukan Bidang Staf.." value="<?php echo $d['bidang']?>">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Nama</label>
                <input type="text" name="nama" id="" class="form-control" rows="" placeholder="Masukan Nama Staf.." value="<?php echo $d['nama']?>">     
              </div>
