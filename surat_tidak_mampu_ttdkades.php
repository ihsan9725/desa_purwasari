  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Keterangan Tidak Mampu</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Keterangan Tidak Mampu</p>
      </div>
      <body>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="cetak_surat_tidak_mampu.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="surat" id="surat" class="form-control" rows="" placeholder="Masukan No Surat..">
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="atas_nama" id="atas_nama">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="staf_desa" id="staf_desa">
