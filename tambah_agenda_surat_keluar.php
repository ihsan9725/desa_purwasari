  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Agenda Surat Keluar</h1>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-success">
            <div class="card-header">
              <h4 class="card-title">Tambah Agenda Surat Keluar</h4>
            ...
            <div class="card-body">
              ...
              <form action="tambah_aksi_agenda_surat_keluar.php" method="post" enctype="multipart/form-data" onsubmit="return validasi()">
                 <div class="form-group">
                  <input type="hidden" name="id" id="id">
                <label for="inputDescription">Berkas Scan Surat Keluar</label>
                <input type="file" name="surat_keluar" id="surat_keluar" class="form-control">
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="tujuan" id="tujuan" class="form-control" rows="" placeholder="">
              </div>
              <div class="form-group">
