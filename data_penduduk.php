...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        ...
        <p>Data Penduduk Desa Purwasari</p>
      </div>
          ...
          <div class="card-header">
            <div class="card-title"> 
              <a href="tambah_data_penduduk.php" class="btn btn-success">Tambah Data</a>
  ...
  ?>
                    ...
                    <td><?php echo $no++ ?></td>
                     <td>
        <a href="edit_data_penduduk.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_data_penduduk.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
