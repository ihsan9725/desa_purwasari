...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        ...
        <p>Pengelompokan Data Rumah Tangga Desa Purwasari</p> 
      </div>
          ...
          <div class="card-header">
            <div class="card-title">
              <a href="tambah_data_rmhtangga.php" class="btn btn-success">Tambah Data</a>
              <a href="cetak_data_rumah_tangga.php" class="btn btn-warning"><i class="fas fa-print"></i></a>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_rmhtangga where nama like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_rmhtangga");   
  }
  $no = 1;
  ...
  ?>
                    ...
                    <td><?php echo $no++ ?></td>
                     <td>
        <a href="edit_data_rmhtangga.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_data_rmhtangga.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
