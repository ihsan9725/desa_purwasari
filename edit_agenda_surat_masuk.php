  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Agenda Surat Masuk</h1>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-success">
            <div class="card-header">
              <h4 class="card-title">Edit Agenda Surat Masuk</h4>
            ...
            <div class="card-body">
              ...
              <form action="update_agenda_surat_masuk.php" method="post" enctype="multipart/form-data">
                 <!-- tampilkan data tabel -->
               <?php
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_buku_agenda_surat_masuk WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query_mysqli)){
  ?>
                 <div class="form-group">
                  <input type="hidden" name="id" value="<?php echo $d['id']?>">
                <label for="inputDescription">Berkas Scan Surat Masuk</label>
                <input type="file" name="surat_masuk" class="form-control" value="<?php echo $d['surat_masuk']?>">
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="pengirim" id="pengirim" class="form-control" rows="" value="<?php echo $d['pengirim']?>">
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="disposisi_kpd" id="disposisi_kpd" class="form-control" rows="" value="<?php echo $d['disposisi_kpd']?>">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Isi Disposisi</label>
                <input type="text" name="isi_disposisi" id="isi_disposisi" class="form-control" rows="" value="<?php echo $d['isi']?>">   
              </div>
