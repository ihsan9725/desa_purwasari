                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <!-- logo-1 -->
                                    <a href="index.php" class="big-logo"><img src="img/logo_karawang.png" height="100px" width="250px" alt=""></a> <!-- logo untuk desa --> 
                                    <!-- logo-2 -->
                                    <a href="index.php" class="small-logo"><img src="logo_karawang.png" height="50px" width="100px" alt=""></a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="hero-cap pt-100">
                            ...
                            <nav aria-label="breadcrumb ">
                                ...
                                <li class="breadcrumb-item"><a href="blog.php"> Berita</a></li> 
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/<?php echo $d['foto']?>" alt="">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="single-blog.php?id=<?php echo $d['id']?>">
                                    <h2><?php echo $d['judul']?></h2>
                                </a>
                                <p><?php echo $d['pra1']?>.</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i><?php echo $d['penulis']?>,<?php echo $d['kategori']?></a></li>
