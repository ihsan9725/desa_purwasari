  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Pengantar Keterangan Catatan Kepolisian</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Keterangan Catatan Kepolisian</p>
      </div>
      <body>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="cetak_surat_SKCK_ttdkades.php" method="post" enctype="multipart/form-data">
