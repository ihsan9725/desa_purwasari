...
<body>
    ...
    <form class="form-inline ml-3">
     ...
     <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Arsip Pelayanan / Pengajuan Surat</h1>
        <p>Arsip Pengajuan Surat Pengantar Masyarakat Desa Mandalahaji</p>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Arsip Pelayanan</h5>
              </div>
              <div class="card-body">
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_arsip_surat where nama like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_arsip_surat");   
  }
  $no = 1;
  ...
  ?>
        ...
        <a href="edit_arsip_surat.php?id=<?php echo $d['id']; ?>"class = "btn btn-success">Edit</a></td>
        <td>
        <a href="hapus_arsip_surat.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');">Hapus</a></td>
        <td>
