  ...
  <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Tambah Data Keluarga</h1>
        <p>Data Keluarga Desa Mandalahaji</p>
      </div>
      <body>
    <!-- Main content -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                 <form action="tambah_aksi_keluarga.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="Text" name="kepala_keluarga" id="nama_ayah" class="form-control" value="">
                </div>
                <!-- /.form-group -->
                 <!-- /.form-group -->
                <div class="form-group">
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                  <label>ID CARD</label>
                  <input type="Text" name="id_card" id="" class="form-control" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
