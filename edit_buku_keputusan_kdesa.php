  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Pengaturan SK Kepala Desa</h1>
      </div>
      <body>
...
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_buku_keputusan_kdesa WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query_mysqli)){
  ?>
              <form action="update_buku_keputusan_kdesa.php" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <input type="text" name="nama_dok" id="nama_dok" class="form-control" rows="" value="<?php echo $d['nama_dok']?>">     
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="no_keputusan" id="no_keputusan" class="form-control" value="<?php echo $d['no_keputusan']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Keputusan Kades</label>
                <input type="date" name="tgl_keputusan_kades" id="tgl_keputusan_kades" class="form-control" value="<?php echo $d['tgl_keputusan_kades']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Dilaporkan</label>
                <input type="date" name="tgl_dilaporkan" id="tgl_dilaporkan" class="form-control" value="<?php echo $d['tgl_dilaporkan']?>">     
              </div>
              <div class="form-group">
