...
<body>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Pemantauan Daftar Pemudik</h5>
              </div>
              <div class="card-body">
               ...
               <!-- tampilkan data tabel -->
                <div class="card mb-5">
        <div class="card-header">
          <div class="card-title"> <a href="#" class="btn btn-success" onclick="">Tambah Wajib Pantau</a> 
             <button type="button" class="btn btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown">
                <span class="sr-only">Toggle Dropdown</span>
                    </button>
                   <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="siaga_covid.php">Pendataan</a>
                      <a class="dropdown-item" href="pemantauan_covid.php">Pemantauan</i></a>
                      <div class="dropdown-divider"></div>
  ...
  if(isset($_GET['cari'])){
    ...
    $data = mysqli_query($koneksi,"select * from tb_covid WHERE wajib_pantau='YA'");   
  }
  $no = 1;
