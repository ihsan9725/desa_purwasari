...
<body>
    ...
    <form class="form-inline ml-3">
     ...
     <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Buku Administrasi Umum - Buku Agenda-Surat Keluar</h1>
        <p></p>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Buku Agenda - Surat Keluar</h5>
              </div>
              <div class="card-body">
               ...
               <!-- tampilkan data tabel -->
                <div class="card mb-5">
        <div class="card-header">
          <div class="card-title"> <a href="tambah_agenda_surat_keluar.php" class="btn btn-success">Tambah Surat Keluar Baru</a>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_buku_agenda_surat_keluar where no_surat like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_buku_agenda_surat_keluar");   
  }
  $no = 1;
  ...
  ?>
        ...
        <a href="edit_agenda_surat_keluar.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_agenda_surat_keluar.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
      </td>
              </td>
               <td><a href="download_agenda_surat_keluar.php?filename=<?=$d['nama']?>" class="btn btn-warning"><i class="fas fa-download"></i></td>
