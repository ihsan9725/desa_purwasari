   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>Tambahkan Foto Pada Galeri</p>
      </div>
      </div>
      </div>
      ...
      <div class="row">
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
               <form action="tambah_aksi_galeri.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="caption" id="inputDescription" class="form-control" placeholder="Masukkan Caption">
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 1</label>
                <textarea class="form-control" type="text" name="pra1" placeholder="Masukkan Pragraf.."></textarea>
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 2</label>
                <textarea class="form-control" type="text" name="pra2" placeholder="Masukkan Pragraf.."></textarea>
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 3</label>
                <textarea class="form-control" type="text" name="pra3" placeholder="Masukkan Pragraf.."></textarea>
              </div>
          ...
          <div class="col-sm-6">
              ...
              <div class="table-responsive">
                ...
                <td><?php echo $d['pra3'] ?></td>
                  <td>
        <a href="edit_galeri.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_galeri.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="JavaScript: return confirm('Apakah anda yakin?')"><i class="fas fa-trash"></i></a>
               </td>
