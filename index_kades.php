        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="logout.php" class="dropdown-item" onClick="javascript : return confirm('Apakah anda yakin untuk log out?')">Log Out</a></li>
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  ...
                  <li>
                    <a tabindex="-1" href="lihat_akun_kades.php" class="dropdown-item">Data Akun</a>
                  </li>
  ...
  while ($row = $result->fetch_assoc()) { 
        ...
        ?></p>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <h5 class="card-title">Surat Yang Belum di tanda tangan.</h5>

                <p class="card-text">
                  Klik tombol berikut untuk menandatangani surat yang belum di tandatangan!.
                </p>
                <!-- untuk menampilkan banyak row pada tb -->
        <?php 
        include 'koneksi.php';
        $data_surat = mysqli_query($koneksi, "SELECT * FROM tb_surat WHERE status_ttd_kades='Belum di Tanda tangan!'");
        $jumlah_surat = mysqli_num_rows($data_surat);
        ?>
                <a href="surat_belum_ttd.php" class="btn btn-primary">Buka Surat<span class="badge badge-danger"> <?php echo $jumlah_surat ?></span></a>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Pengajuan Surat Online Masyarakat Desa Mandalahaji</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Untuk lihat pengajuan surat</h6> 
                <p class="card-text">Tekan Tombol Di bawah</p>
                  <!-- untuk menampilkan banyak row pada tb -->
        <?php 
        include 'koneksi.php';
        $data_surat = mysqli_query($koneksi, "SELECT * FROM tb_surat WHERE status_post = 'Diterima' ");
        $jumlah_surat = mysqli_num_rows($data_surat);
        ?>
                <a href="data_surat_kades.php" class="btn btn-primary">Tampilkan<span class="badge badge-danger"> <?php echo $jumlah_surat ?></span></a>
              </div>
            </div>

            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0">Lihat Pengguna/User</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Untuk lihat Akun Pengguna Klik tombol dibawah!</h6>

                <p class="card-text"></p>
                <a href="lihat_akun_kades.php" class="btn btn-primary">Tampilkan</a>
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
