  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Keterangan Beda Nama/Identitas</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Keterangan Beda Nama/Identitas</p>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form action="cetak_surat_beda_nama_ttdkades.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="inputDescription" class="btn-primary">IDENTITAS KEDUA</label>  
              </div>
               <div class="form-group">
                <label for="inputDescription">Identitas dalam(nama kartu)</label>
                <input type="text" name="form_nama_kartu" id="form_nama" class="form-control" placeholder="Masukan Identitas..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">No Identitas</label>
                <input type="text" name="form_identitas" id="form_identitas" class="form-control" placeholder="Masukan No Identitas..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Nama</label>
                <input type="text" name="form_nama" id="form_nama" class="form-control" placeholder="Masukan Nama..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Tempat Tanggal Lahir</label>
                <input type="text" name="form_tmplahir" id="form_tmplahir" class="form-control" placeholder="Masukan Tempat Lahir..">
                <input type="date" name="form_tgllahir" id="form_tgllahir" class="form-control" placeholder="Masukan Tempat Lahir..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Jenis Kelamin</label>
                <input type="text" name="form_sex" id ="form_sex"class="form-control" placeholder="Masukan Jenis Kelamin..">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Alamat</label>
                <input type="text" name="form_alamat" id ="form_alamat"class="form-control" placeholder="Masukan Jenis Kelamin..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Agama</label>
                <input type="text" name="form_agama" id="form_agama" class="form-control" placeholder="Masukan Agama..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Pekerjaan</label>
                <input type="text" name="form_pekerjaan" id="form_pekerjaan"class="form-control" placeholder="Masukan Pekerjaan..">   
              </div>
               <div class="form-group">
                <label for="inputDescription">Keterangan</label>
                <textarea type="text" name="form_keterangan" id="form_keterangan" class="form-control" placeholder="Masukan Keterangan.."></textarea>   
              </div>
               <div class="form-group">
