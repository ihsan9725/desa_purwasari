...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" type="text" name="cari" placeholder="Cari Judul Dokumen" aria-label="Search">
     ...
     <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Buku Administrasi Umum - Buku Keputusan Kepala Desa</h1>
        <p></p>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Buku Keputusan Kepala Desa</h5>
              </div>
              <div class="card-body">
               ...
               <!-- tampilkan data tabel -->
                <div class="card mb-5">
        <div class="card-header">
          <div class="card-title"> <a href="tambah_buku_keputusan_kdesa.php" class="btn btn-success">Tambah SK Kades Baru</a>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_buku_keputusan_kdesa where judul_dok like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_buku_keputusan_kdesa");   
  }
  $no = 1;
  ...
  ?>
        ...
        <a href="edit_buku_keputusan_kdesa.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_buku_keputusan_kdesa.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
      </td>
              </td>
               <td><a href="download.php?filename=<?=$d['dok']?>" class="btn btn-warning"><i class="fas fa-download"></i></td>

                <td><?php echo $d['id'] ?></td>
                <td><?php echo $d['judul_dok'] ?></td>
                <td><?php echo $d['tgl_keputusan_kades'] ?></td>
                <td><?php echo $d['uraian'] ?></td>
                <td>YA</td>
                <td><?php echo $d['tgl_dilaporkan'] ?></td>
                  <?php }?>
