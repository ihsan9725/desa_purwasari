...
<link rel="shortcut icon" type="image/x-icon" href="img/kabupaten_karawang.png">
 ...
 <!-- Google Font: Source Sans Pro -->
  ...
  <style>
        .kbw-signature { width: 400px; height: 300px;}
        #sig canvas{
            width: 100% !important;
            height: auto;
...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Penghasilan</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Penghasilan</p>
      </div>
      <body>
            ...
            <div class="card-header">
             ...
             <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="cetak_surat_penghasilan.php" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
                ...
                <select class="form-control" name="pilih_dari_nik" onchange="changeValueNIK(this.value)">
                  ...
                  while($d = mysqli_fetch_array($data)){ 
                    echo '<option value="'.$d['nik']. '" value="tidak ada">'.$d['nama'].' -- '.$d['nik'].'</option>';
                  $jsArray .= "prdName['" . $d['nik'] . "'] = {nama:'".addslashes($d['nama'])."',nik:'".addslashes($d['nik'])."',kk:'".addslashes($d['kk'])."',ayah:'".addslashes($d['nama_ayah'])."',nok:'".addslashes($d['nik_ayah'])."',ibu:'".addslashes($d['nama_ibu'])."',noik:'".addslashes($d['nik_ibu'])."',tmp_lahir:'".addslashes($d['tmp_lahir'])."',tgl_lahir:'".addslashes($d['tgl_lahir'])."',alamat:'".addslashes($d['alamat'])."',status_perkawinan:'".addslashes($d['status_perkawinan'])."',pendidikan_ditempuh:'".addslashes($d['pendidikan_ditempuh'])."',pekerjaan:'".addslashes($d['pekerjaan']). "',agama:'".addslashes($d['agama']). "',jenis_kelamin:'".addslashes($d['jenis_kelamin']). "'};\n";
                  ?>
                <?php } ?>
                </select>  
              </div>
               <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
               <div class="form-group">
                <label for="inputDescription">NIK</label>
                <input type="text" name="nik" id="nik" class="form-control" rows="" placeholder="" maxlength="18" onkeypress="return hanyaAngka(event)">     
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="ayah" id="ayah" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)"> 
                <input type="text" name="nok" id="nok" class="form-control" rows="" placeholder="" maxlength="18" onkeypress="return hanyaAngka(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Pekerjaan Ayah</label>
                <input type="text" name="job" id="job" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Nama Ibu/NIK</label>
                <input type="text" name="ibu" id="ibu" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)"> 
                <input type="text" name="noik" id="noik" class="form-control" rows="" placeholder="" axlength="18" onkeypress="return hanyaAngka(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Pekerjaan Ibu</label>
                <input type="text" name="work" id="work" class="form-control" rows="" placeholder="" axlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                ...
                <input type="text " name="umur" id="umur" class="form-control" rows="" placeholder="" maxlength="3" onkeypress="return hanyaAngka(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Alamat</label>
                <input type="text" name="alamat" id="alamat" class="form-control" rows="" placeholder="" maxlength="90" >     
              </div>
              <div class="form-group">
                <label for="inputDescription">Status</label>
                <input type="text" name="status_perkawinan" id="status_perkawinan" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Pekerjaan</label>
                <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Pendidikan/Warga Negara/Agama</label>
                <input type="text " name="pendidikan_ditempuh" id="pendidikan_ditempuh" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">
                <input type="text " name="warga1" id="warga1" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">
                <input type="text " name="agama" id="agama" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Jenis Kelamin</label>
                <input type="text" name="jenis_kelamin" id="jenis_kelamin" class="form-control" rows="" placeholder="" maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
               <div class="form-group">
                <label for="inputDescription">No Surat</label>
                <input type="text" name="surat" id="" class="form-control" rows="" placeholder="Masukan No Surat.." maxlength="20">
              </div>
              <div class="form-group">
                <label for="inputDescription">No Induk Siswa/Mahasiswa</label>
                <input type="text" name="no_induk" id="" class="form-control" rows="" placeholder="Masukan No Induk.." maxlength="12" onkeypress="return hanyaAngka(event)">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Sekolah/Perguruan Tinggi</label>
                <input type="text" name="sekolah" id="" class="form-control" rows="" placeholder="Masukan Nama sekolah.." maxlength="50" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Kelas/Semester</label>
                <input type="text" name="semester" id="semester" class="form-control" rows="" placeholder="Masukan Kelas.." maxlength="30">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Jurusan/Fakultas/Prodi</label>
                <input type="text" name="jurusan" id="jurusan" class="form-control" rows="" placeholder="Masukan Jurusan.." maxlength="30" onkeypress="return hanyaHuruf(event)">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Jumlah Penghasilan Ayah/Ibu</label>
                <input type="text" name="jml_penghasilan" id="jml_penghasilan" class="form-control" rows="" placeholder="Masukan Jumlah Penghasilan.." maxlength="30">     
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="staf_desa">
                  ...
                  while($d = mysqli_fetch_array($data)){ ?>
                  <option value=""><?php echo $d['nama']?></option><?php }?>
                </select>      
              </div>
              <div class="form-group">
              ...
              <a href="jenis_surat.php" class="btn btn-danger float-right" onClick="javascript: return confirm('Apakah Anda Yakin Untuk Batal?');"><i class="fal fa-times-octagon"></i>Batal</a>
            </div>
  ...
  <script>
    ...
    function changeValueNIK(nik){
      ...
      document.getElementById('nok').value = prdName[nik].nok;
      document.getElementById('ibu').value = prdName[nik].ibu;
      document.getElementById('noik').value = prdName[nik].noik;
  ...
  function validasi() {
    ...
    if (&& nama !="" nik != "" && kk!=""  && ayah !="" && nok !="" && ibu !="" && noik !="" && tmp_lahir !="" && ibu !="" && tgl_lahir !="" && alamat !="" && status_perkawinan !="" && pendidikan_ditempuh !="" && pekerjaan !="" && agama !="" && jenis_kelamin !="") {
      return true;
    }else{
...
$("#pilih_dari_nik").change(function() {
      console.log($("#pilih_dari_nik option:selected").val());
      if ($("#pilih_dari_nik option:selected").val() == 'tidak ada' ) {
...
function hanyaHuruf(evt){
       ...
       <!-- jSignature -->
        ...
        <script src="jSignature-master/libs/modernizr.js"></script>
