      ...
      <div class="row">
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
               <form action="tambah_aksi_pelayanan.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="jenis_layanan" id="jenis_layanan" class="form-control" placeholder="Masukkan Jenis Layanan">
              </div>
              <div class="form-group">
                <label for="inputDescription">Deskripsi</label>
                <textarea class="form-control" type="text" name="deskripsi" placeholder="Masukkan Deskripsi.."></textarea>
              </div>
               <div class="form-group">
