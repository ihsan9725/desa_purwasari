          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="tambah_aksi_persyaratan.php" method="post" enctype="multipart/form-data">
               <div class="form-group">
                <label for="inputDescription">Nama Dokumen</label>
                <input type="hidden" name="id">
                <input type="text" name="nama_dok" id="nama_dok" class="form-control" rows="" placeholder="Dokumen">
          ...
          <div class="col-sm-6">
              ...
              <div class="table-responsive">
                ...
                <td><?php echo $d['nama_dok']?></td>
                  <td>
        <a href="edit_persyaratan.php?id=<?php echo ($d['id']); ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_persyaratan.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger"><i class="fas fa-trash"></i></a></td>   
               </td>
