...
<div class="wrapper">
  ...
  while ($row = $result->fetch_assoc()) { 
        ...
        ?>
          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- tampilkan tbl pengajuan surat warga -->
          ...
          include "koneksi.php";
          $sql="SELECT * FROM tb_surat WHERE status_post='Diterima' ORDER BY id_surat DESC";
          $no=1;
        ...
        ?>
                    <tr>
               <td><?php echo $no++ ?></td>
               <td><b><button class="btn btn-warning disabled"><?php echo $d['status_post']?></button></b></td>
    ...
    <!-- /#page-content-wrapper -->
                ...
                <a href="index_kades.php" class="btn btn-primary">Tutup Tampilan</a>
                <a href="detail_surat.php" class="btn btn-warning">Detail Surat</a>
              </div>
            </div>
          </div>
