  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Tambah Data Staf</h1>
        <p>Halaman Ini Digunakan Untuk Menambah Data Staf Desa Mandalahaji</p>
      </div>
      <body>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="tambah_aksi_staf.php" method="post" enctype="multipart/form-data">
               <div class="form-group">
                <label for="inputDescription">Foto</label>
                <input type="hidden" name="id">
                <input type="file" name="foto" id="foto" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Bidang</label>
                <input type="text" name="bidang" id="bidang" class="form-control" rows="" placeholder="Masukan Bidang Staf..">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Nama</label>
                <input type="text" name="nama" id="nama" class="form-control" rows="" placeholder="Masukan Nama Staf..">     
              </div>
