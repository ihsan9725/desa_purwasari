...
<div class="wrapper">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                   ...
                   <li>
                    <a tabindex="-1" href="data_tamu_kades.php" class="dropdown-item">Data Staf Aparat Desa</a>
                  </li>
                  <li>
      ...
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1 class="m-0 text-dark"> Hallo Kepala Desa <small><b><?php 
              $result = mysqli_query($koneksi, "SELECT * FROM tb_user WHERE id = '".$id_user."' ");
              while ($row = $result->fetch_assoc()) { echo $row['nama']; }?>!</b></small></h1> 
  ...
  while ($row = $result->fetch_assoc()) { 
        ...
        ?></p>
          ...
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Data Staf Aparat Pemerintah Desa</b></h5><br>
                 <h6 class="card-title">Halaman ini memuat data staf aparat pemerintah Desa Mandalahaji.</h6><br>
                 <a href="cetak_data_staf_kades.php" class="btn btn-warning"><i class="fas fa-print"></i></a>
              </div>
              <div class="card-body">
          ...
          include "koneksi.php";
          $sql="SELECT * FROM tb_aparat_pemerintahds";
          $no=1;
