  ...
  while ($row = $result->fetch_assoc()) { 
        ...
        ?></p>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <h5 class="card-title"><b>Pengajuan Surat Saya</b></h5>

                <p class="card-text">
                  Pada halaman ini anda dapat melihat surat yang anda ajukan melalui sistem
                </p>
                <a href="token_pengajuan.php" class="card-link">Lihat Pengajuan</a>
          ...
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Pengajuan Surat Online</b></h5>
              </div>
              <div class="card-body">
                ...
                <p class="card-text">Rekomendasi, untuk pengajuan surat user diharuskan untuk mengisi biodata penduduk agar memudahkan proses pencetakan surat!</p>
                <a href="tambah_data_penduduk_user.php" class="btn btn-primary">Daftar Kependudukan<span class="badge badge-danger rights"> !</span></a>
                <a href="surat_A.php" class="btn btn-primary">Ajukan</a>
              </div>
            </div>
            <!-- /.col-md-6 -->
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Kotak Masuk/Ambil Surat Yang Anda Ajukan Pada Halaman ini</b></h5> 
              </div>
              <div class="card-body">
                <h6 class="card-title">Kotak Masuk.</h6>
                <p class="card-text"></p>
                <!-- untuk menampilkan banyak row pada tb -->
        <?php 
        include 'koneksi.php';
        $data_surat = mysqli_query($koneksi, "SELECT * FROM tb_surat_keuser WHERE id_user ='$id_user'");
        $jumlah_surat = mysqli_num_rows($data_surat);
        ?>
                <a href="kotak_masuk.php" class="btn btn-success">Ambil Surat<span class="badge badge-danger rights"> <?php echo $jumlah_surat ?></span></a>
              </div>
            </div>

            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Pembuatan Sertifikat Tanah</b></h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Sertifikat Tanah Desa Mandalahaji</h6>

                <p class="card-text">Pada halaman ini masyarakat desa mandalahaji dapat mengajukan pembuatan surat/sertifikat tanah.</p>
                <a href="sertifikat_tanah.php" class="btn btn-primary disabled">Ajukan</a>
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
