 ...
 <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>Halaman Ini Digunakan Untuk Edit Galeri Kantor Desa Mandalahaji</p>
      </div>
...
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_galeri WHERE id='$id'")or die(mysqli_errors());
  ...
  ?>
              ...
              <img src="img/<?php echo $d['foto']?>" height="50dp" width="50dp">
               ...
               <div class="form-group">
                ...
                <input type="text" name="caption" id="inputDescription" class="form-control" rows="" placeholder="Masukkan Deskripsi" value="<?php echo $d['caption']?>">
              </div>
               <div class="form-group">
