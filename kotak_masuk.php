  ...
  while ($row = $result->fetch_assoc()) { 
          ...
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Kotak Masuk Pengajuan Surat</b></h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Download surat yang anda ajukan disini!.</h6>
              </div>
              <!-- Default box -->
      ...
      <div class="card card-solid">
        <div class="card-body pb-0">
          ...
          include "koneksi.php";
          $sql="SELECT * FROM tb_surat_keuser WHERE id_user = '$id_user'";
          $no=1;
              ...
              <div class="card bg-light">
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="index_user.php" class="btn btn-sm bg-teal">
