  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Keterangan Usaha</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Keterangan Usaha</p>
      </div>
      <body>
          ...
          <div class="card card-primary">
           ...
           <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="cetak_surat_usaha_ttdkades.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="inputDescription">Nama/Jenis Usaha</label>
                <input type="text" name="jenis_usaha" id="jenis_usaha" class="form-control" rows="" placeholder="Masukan Jenis Usaha..">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Keperluan</label>
                <textarea type="text" name="keperluan" id="keperluan" class="form-control" placeholder="Masukan Keterangan.."></textarea>   
              </div>
              <div class="form-group">
                <label for="inputDescription">Berlaku Dari - Sampai</label>
                <input type="date" name="berlaku_dari" id="" class="form-control" rows="" placeholder="Masukan Nama Staf..">
