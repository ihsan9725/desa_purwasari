...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index_kades.php">Home</a></li>
  ...
  while ($row = $result->fetch_assoc()) { 
          ...
          <div class="col-12">
            <div class="card card-warning card-outline">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Data Akun</b></h5><br>
                 <h6 class="card-title">Halaman ini memuat akun yang terdaftar pada Sistem Informasi Desa Mandalahaji.</h6>
              </div>
              <div class="card-body">
        ...
        <a href="#.php?id=<?php echo $d['id']; ?>"class = "btn btn-success">Edit</a></td>
        <td>
        <a href="#.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');">Hapus</a></td>
