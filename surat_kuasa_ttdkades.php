...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Surat Keterangan Kepemilikan Tanah</h1>
        <p>Halaman Ini Digunakan Untuk Mencetak Surat Keterangan Kepemilikan Tanah</p>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form action="cetak_surat_kuasa_ttdkades.php" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                <label for="inputDescription" class="btn-success form-control">PEMBERI KUASA</label>   
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="inputDescription" class="btn-primary form-control">DATA PENERIMA KUASA DARI DB/WARGA DESA</label>  
              </div>
              <!-- pilih dari nik untuk penerima kuasa -->
                 <div class="form-group">
                <label for="inputDescription">Pilih Dari NIK</label>
                <select class="form-control" name="pilih_dari_nik2" onchange="changeValueNIK2(this.value)">
                  <option selected="selected">Pilih Dari NIK</option>
                  <?php
                  include 'koneksi.php';
                  $data = mysqli_query($koneksi,"select * from tb_penduduk");
                  ...
                  while($d = mysqli_fetch_array($data)){ 
                    echo '<option value="'.$d['nik']. '">'.$d['nama'].' -- '.$d['nik'].'</option>';
                  $jsArray .= "prdName['" . $d['nik'] . "'] = {nama2:'".addslashes($d['nama'])."',nik2:'".addslashes($d['nik'])."',kk2:'".addslashes($d['kk'])."',ayah2:'".addslashes($d['nama_ayah'])."',tmp_lahir2:'".addslashes($d['tmp_lahir'])."',tgl_lahir2:'".addslashes($d['tgl_lahir'])."',alamat2:'".addslashes($d['alamat'])."',status_perkawinan2:'".addslashes($d['status_perkawinan'])."',pendidikan_ditempuh2:'".addslashes($d['pendidikan_ditempuh'])."',pekerjaan2:'".addslashes($d['pekerjaan']). "',agama2:'".addslashes($d['agama']). "',jenis_kelamin2:'".addslashes($d['jenis_kelamin']). "'};\n";
                  ?>
                <?php } ?>
                </select>  
              </div>
               <div class="form-group">
                <label for="inputDescription" class="btn-success form-control">PENERIMA KUASA</label>   
              </div>
               <div class="form-group">
                <label for="inputDescription">Nama</label>
                <input type="hidden" name="id" id="id">
                <input type="text" name="nama2" id="nama2" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription">NIK</label>
                <input type="text" name="nik2" id="nik2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">KK</label>
                <input type="text" name="kk2" id="kk2" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Kepala Keluarga</label>
                <input type="text" name="ayah2" id="ayah2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Tempat/Tanggal lahir/Umur</label>
                
                <input type="text " name="tmp_lahir2" id="tmp_lahir2" class="form-control" rows="" placeholder="">
                <input type="text " name="tgl_lahir2" id="tgl_lahir2" class="form-control" rows="" placeholder="">
                <input type="text " name="umur2" id="umur2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Alamat</label>
                <input type="text" name="alamat2" id="alamat2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Status</label>
                <input type="text" name="status_perkawinan2" id="status_perkawinan2" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Pekerjaan</label>
                <input type="text" name="pekerjaan2" id="pekerjaan2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Pendidikan/Warga Negara/Agama</label>
                <input type="text " name="pendidikan_ditempuh2" id="pendidikan_ditempuh2" class="form-control" rows="" placeholder="">
                <input type="text " name="warga12" id="warga12" class="form-control" rows="" placeholder="">
                <input type="text " name="agama2" id="agama2" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Jenis Kelamin</label>
                <input type="text" name="jenis_kelamin2" id="jenis_kelamin2" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription" class="btn-success form-control">PENANDATANGANAN</label>  
              </div>
              <div class="form-group">
              ...
              <button type="submit" class="btn btn-primary float-left" onClick="javascript: return confirm('Apakah Data Yang Anda Masukkan Sudah Benar?');">Cetak PDF</button>
  ...
  <script>
    ...
    <?php echo $jsArray; ?>
    function changeValueNIK2(nik){
      document.getElementById('nama2').value = prdName[nik].nama2;
      document.getElementById('nik2').value = prdName[nik].nik2;
      document.getElementById('kk2').value = prdName[nik].kk2;
      document.getElementById('ayah2').value = prdName[nik].ayah2;
      document.getElementById('tmp_lahir2').value = prdName[nik].tmp_lahir2;
      document.getElementById('tgl_lahir2').value = prdName[nik].tgl_lahir2;
      document.getElementById('alamat2').value = prdName[nik].alamat2;
      document.getElementById('status_perkawinan2').value = prdName[nik].status_perkawinan2;
      document.getElementById('pendidikan_ditempuh2').value = prdName[nik].pendidikan_ditempuh2;
      document.getElementById('pekerjaan2').value = prdName[nik].pekerjaan2;
      document.getElementById('agama2').value = prdName[nik].agama2;
      document.getElementById('jenis_kelamin2').value = prdName[nik].jenis_kelamin2;
    };
  </script>
