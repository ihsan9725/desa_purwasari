  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>Halaman untuk menambahkan berita</p>
      </div>
      </div>
      </div>
      ...
      <div class="row">
        <div class="card-body">
          <div class="card card-primary">
            ...
            <div class="card-body">
               <form action="tambah_aksi_berita.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Masukkan Tanggal..">
              </div>
              <div class="form-group">
                <label for="inputDescription">Judul</label>
                <input type="text" name="judul" id="judul" class="form-control" placeholder="Masukkan Judul Berita..">
              </div>
              <div class="form-group">
                <label for="inputDescription">Kategori</label>
                <input type="text" name="kategori" id="kategori" class="form-control" placeholder="Masukkan Deskripsi..">
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 1</label>
                <textarea class="form-control" type="text" name="pra1" placeholder="Masukkan Isi Berita.."></textarea>
              </div>
               <div class="form-group">
                <label for="inputDescription">Pragraf 2</label>
                 <textarea class="form-control" type="text" name="pra2" placeholder="Masukkan Isi Berita.."></textarea>
              </div>
               <div class="form-group">
                <label for="inputDescription">Pragraf 3</label>
                 <textarea class="form-control" type="text" name="pra3" placeholder="Masukkan Isi Berita.."></textarea>
              </div>
               <div class="form-group">
                <label for="inputDescription">Pragraf 4</label>
                 <textarea class="form-control" type="text" name="pra4" placeholder="Masukkan Isi Berita.."></textarea>
              </div>
              <div class="form-group">
                <label for="inputDescription">Kutipan</label>
                 <textarea class="form-control" type="text" name="kutipan" placeholder="Masukkan Isi Berita.."></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="komen" id="komen" class="form-control" placeholder="Masukkan Komentar..">
              </div>
