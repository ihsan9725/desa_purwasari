...
<body>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Edit Profil Desa Purwasari</h1>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
               ...
               <?php
                include "koneksi.php";
                $id = $_GET['id'];
                $query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_about WHERE id='$id'")or die(mysqli_error());
              ...
              <div class="form-group">
                ...
                <input type="text" name="judul" id="judul" class="form-control" placeholder="Masukan Judul" value="<?php echo $d['judul']?>">
               
              </div>
              <div class="form-group">
                <label for="inputDescription">Sub Judul</label>
                <input type="text" name="sub_judul" id="sub_judul" class="form-control" rows="" placeholder="Masukkan Sub Judul" value="<?php echo $d['sub_judul']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Foto</label>
                <input type="file" name="nama" id="nama" class="form-control" rows="" placeholder="Tambahkan Foto" value="<?php echo $d['nama']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Isi</label>
                <input type="text" name="isi" id="isi" class="form-control" placeholder="Masukkan Isi Pragraf" value="<?php echo $d['isi']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Tahun</label>
                <input type="text" name="tahun" id="tahun" class="form-control" placeholder="Masukkan Isi Pragraf" value="<?php echo $d['tahun']?>">
              </div>
