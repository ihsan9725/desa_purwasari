  ...
  <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Tambah Data Kelompok</h1>
        <p>Data Kelompok/organisasi Desa Mandalahaji</p>
      </div>
      <body>
    <!-- Main content -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                 <form action="tambah_aksi_kelompok.php" method="post" enctype="multipart/form-data">
                  ...
                  $jsArray .= "prdName['" . $d['nik'] . "'] = {nama:'".addslashes($d['nama'])."',nama_ayah:'".addslashes($d['nama_ayah'])."',nik:'".addslashes($d['nik'])."',alamat:'".addslashes($d['alamat'])."',jenis_kelamin:'".addslashes($d['jenis_kelamin']). "'};\n";
                  ?>
                <?php } ?>
                  </select>  
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="Text" name="kode_kel" id="kode_kel" class="form-control" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Nama Kelompok</label>
                  <input type="Text" name="nama_kel" id="" class="form-control" value="">
                </div>
                <!-- /.form-group -->
                 <!-- /.form-group -->
                <div class="form-group">
                ...
                <!-- /.form-group -->
                 <div class="form-group">
                  ...
                  <input type="Text" name="ketua_kel" id="nama" class="form-control" value="">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
