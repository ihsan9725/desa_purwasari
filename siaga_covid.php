...
<body>
    ...
    <form class="form-inline ml-3">
     ...
     <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        ...
        <p>Daftar Pemudik Saat Pandemi Covid-19</p>
      </div>
      ...
      <!-- box tabel -->
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Daftar Pemudik</h5>
              </div>
              <div class="card-body">
        ...
        <div class="card-header">
          <div class="card-title"> 
            <a href="tambah_covid.php" class="btn btn-success">Tambah Warga Pemudik</a> 
            <a href="cetak_pemudik_covid19.php" class="btn btn-warning"><i class="fas fa-print"></i></a> 
             <button type="button" class="btn btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown">
                <span class="sr-only">Toggle Dropdown</span>
                    </button>
                   <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="siaga_covid.php">Pendataan</a>
                    <a class="dropdown-item" href="pemantauan_covid.php">Pemantauan</a>
                      <div class="dropdown-divider"></div>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_covid where nama like '%".$cari."%'");       
  }else{
  ...
  ?>
        ...
        <a href="edit_covid.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_covid.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a></td>
              </td>
