...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Manajemen Akun Penduduk</h1>
  ...
  ?>
                    ...
                    <td><?php echo $no++ ?></td>
                     <td>
        <a href="edit_manajemen_akun.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_manajemen_akun.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
