...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Data Kelompok</h1>
        <p>Data Kelompok/organisasi Desa Purwasari</p>
          ...
          <div class="card-header">
            <div class="card-title">
              <a href="tambah_data_kelompok.php" class="btn btn-success">Tambah Data</a>
              <a href="cetak_data_kelompok.php" class="btn btn-warning"><i class="fas fa-print"></i></a>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_kelompok where kepala_keluarga like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_kelompok");   
  }
  $no = 1;
  ...
  ?>
                    ...
                    <td><?php echo $no++ ?></td>
                     <td>
        <a href="edit_data_kelompok.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_data_kelompok.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
                   
                    <td><?php echo $d['kode_kel'] ?></td>
                    <td><?php echo $d['nama_kel'] ?></td>
                    <td><?php echo $d['ketua_kel'] ?></td>
