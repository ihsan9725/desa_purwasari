...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="img/kabupaten.png">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <!-- logo-1 -->
                                    <a href="index.php" class="big-logo"><img src="img/mandalahaji.png" alt="" height="100px" width="250px"></a>
                                    <!-- logo-2 -->
                                    <a href="index.php" class="small-logo"><img src="img/mandalahaji.png" alt="" height="50px" width="100px"></a>
                                </div>
                            </div>
        ...
        <div class="slider-area ">
            <!-- tampilkan data tabel -->
               <?php
                    include "koneksi.php";
                    $id = $_GET['id'];
                    $query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_layanan WHERE id='$id'")or die(sqlsrv_errors());
                    while($d = mysqli_fetch_array($query_mysqli)){
                     ?>
            <div class="single-slider hero-overly slider-height2 d-flex align-items-center" data-background="img/<?php echo $d['foto']?>">
                <div class="container">
                    <div class="row">
                         
                        <div class="col-lg-10 col-xl-8">
                            <div class="hero-cap hero-cap2 pt-120">
                                <h2><?php echo $d['jenis_layanan']?></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="single-services section-padding2">
                            <div class="details-img mb-40">
                                <img src="img/<?php echo $d['foto']?>" alt="">
                            </div>
                            <div class="details-caption">
                                <p><?php echo $d['deskripsi']?></p>

                                <p class="mb-50"><?php echo $d['pra1']?></p>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-7">
                                <div class="single-footer-caption mb-50">
                                    <div class="footer-tittle">
                                        <h4>Kontak</h4>
                                        <div class="footer-pera">
                                            <p class="info1">Jalan Raya Cigagak No.17 Desa Mandalahaji Kec.Pacet</p>
                                        </div>
                                        <ul>
