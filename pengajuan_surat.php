...
<body>
    ...
    <form class="form-inline ml-3">
     ...
     <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Data Pengajuan Surat</h1>
      ...
      <!-- box tabel -->
        ...
        <div class="card-header">
          <div class="card-title"> 
            <a href="#" class="btn btn-success">Pilihan Lain</a> 
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_surat where nama like '%".$cari."%'");       
  }else{
              ...
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-7">
                      <h5 class="lead"><b><?php echo $d['nama']?></b></h5>
                      ...
                      <p class="text-muted text-sm"><b>Pesan: </b><?php echo $d['pesan']?></p>
                       <p class="text-muted text-sm"><b>Status TTD Kades: </b><?php echo $d['status_ttd_kades']?></p>
                    ...
                    <a href="approve_pengajuan_surat.php?id_surat=<?php echo $d['id_surat']; ?>"class="btn btn-primary"><i class="fas fa-check"></i></a>
                    <a href="tolak_pengajuan_surat.php?id_surat=<?php echo $d['id_surat']; ?>"class="btn btn-danger"><i class="fas fa-times"></i></a>
                    <a href="edit_pengajuan_surat.php?id_surat=<?php echo $d['id_surat']; ?>"class="btn btn-warning"><i class="fas fa-edit"></i></a>
                    <a href="hapus_pengajuan_surat.php?id_surat=<?php echo $d['id_surat']; ?>"class="btn btn-danger" onClick="JavaScript: return confirm('Apakah Anda Yakin?');"><i class="fas fa-trash"></i></a>
                    </div>
