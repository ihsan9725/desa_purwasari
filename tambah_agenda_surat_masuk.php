...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Agenda Surat Masuk</h1>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-success">
            <div class="card-header">
              <h4 class="card-title">Tambah Agenda Surat Masuk</h4>
            ...
            <div class="card-body">
              ...
              <form action="tambah_aksi_agenda_surat_masuk.php" method="post" enctype="multipart/form-data" onsubmit="return validasi()">
                 <div class="form-group">
                  <input type="hidden" name="id" id="id">
                <label for="inputDescription">Berkas Scan Surat Masuk</label>
                <input type="file" name="surat_masuk" id="surat_masuk" class="form-control">
              </div>
               <div class="form-group">
                <label for="inputDescription">No Urut</label>
                <input type="text" name="no_urut" id="no_urut" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Kode/Klasifikasi Surat</label>
                <input type="text" name="klasifikasi" id="klasifikasi" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
                <label for="inputDescription">No Surat</label>
                <input type="text" name="no_surat" id="no_surat" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Surat</label>
                <input type="date" name="tgl_surat" id="tgl_surat" class="form-control" rows="" placeholder="">
              </div>
               <div class="form-group">
                <label for="inputDescription">Pengirim</label>
                <input type="text" name="pengirim" id="pengirim" class="form-control" rows="" placeholder="">
              </div>
              <div class="form-group">
                <label for="inputDescription">Isi Singkat/Perihal</label>
                <textarea type="text" name="isi" id="isi" class="form-control" rows="" placeholder=""></textarea>   
              </div>
              <div class="form-group">
                <label for="inputDescription">Disposisi Kepada</label>
                <input type="text" name="disposisi_kpd" id="disposisi_kpd" class="form-control" rows="" placeholder="">
              </div>
               <div class="form-group">
                <label for="inputDescription">Isi Disposisi</label>
                <textarea type="text" name="isi_disposisi" id="isi_disposisi" class="form-control" rows="" placeholder=""></textarea>   
              </div>
  ...
  function validasi() {
    var surat_masuk = document.getElementById("surat_masuk").value;
    ...
    var disposisi_kpd = document.getElementById("disposisi_kpd").value;
    var isi_disposisi = document.getElementById("isi_disposisi").value;

    if (surat_masuk !="" && no_urut != "" && klasifikasi !="" && no_surat !="" && tgl_surat !="" && pengirim !="" && isi !="" && disposisi_kpd !="" && isi_disposisi !="") {
      return true;
    }else{
