...
<body>
   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <!-- get data cari nama -->
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Manajemen Akun Sistem</h1>
        <p>Data Akun Terdaftar Penduduk Desa Purwasari</p>
      </div>
          ...
          <div class="card-header">
            <div class="card-title"> 
              <a href="tambah_akun.php" class="btn btn-success">Tambah Data</a>
              <a href="#.php" class="btn btn-warning"><i class="fas fa-print"></i></a>
              <button type="button" class="btn btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown">
                <span class="sr-only">Toggle Dropdown</span>
                    </button>
                   <div class="dropdown-menu" role="menu">
                   <a class="dropdown-item" href="manajemen_akun.php">Manajemen Akun Penduduk</a>
                      <a class="dropdown-item" href="manajemen_akun_sistem.php">Manajement Akun Sistem</a>
  ...
  if(isset($_GET['cari'])){
    $cari = $_GET['cari'];
    $data = mysqli_query($koneksi,"select * from tb_auth where nama like '%".$cari."%'");       
  }else{
    $data = mysqli_query($koneksi,"select * from tb_auth");   
  }
  $no = 1;
  ...
  ?>
                    ...
                    <td><?php echo $no++ ?></td>
                     <td>
        <a href="edit_manajemen_akun_sistem.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_manajemen_akun_sistem.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="javascript: return confirm('Apakah anda yakin?');"><i class="fas fa-trash"></i></a>
               </td>
