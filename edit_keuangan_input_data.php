  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Anggaran / Realisasi</h1>
      </div>
      <body>
        ...
        <div class="card-body">
          <div class="card card-success">
            ...
            <div class="card-body">
              ...
              <form action="update_keuangan_input_data.php" method="post" enctype="multipart/form-data">
                 <!-- tampilkan data tabel -->
               <?php
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_input_anggaran WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query_mysqli)){
  ?>
                <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $d['id']?>">
                <label for="inputDescription">Tahun</label>
                <input type="text" name="tahun" class="form-control" value="<?php echo $d['tahun']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Jenis Anggaran</label>
                <select class="form-control" name="jenis_anggaran" >
                  <option selected="selected"><?php echo $d['jenis_anggaran']?></option>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="kode_rincian">
                  <option selected="selected"><?php echo $d['kode_rincian']?></option>
               ...
               <div class="form-group">
                ...
                <input type="text" name="nilai_anggaran" id="nilai_anggaran" class="form-control" rows="" value="<?php echo $d['nilai_anggaran']?>">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Nilai Realisasi</label>
                <input type="text" name="nilai_real" id="nilai_real" class="form-control" rows="" value="<?php echo $d['nilai_real']?>">     
              </div>
