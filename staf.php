   ...
   <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Data Staf Desa Mandalahaji</h1>
        <p>Data Staf Kantor Desa Mandalahaji</p>
      </div>
       ...
       <!-- box tabel -->
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Data Staf</h5>
              </div>
              <div class="card-body">
               ...
               <!-- tampilkan data tabel -->
                <div class="card mb-5">
        <div class="card-header">
          <div class="card-title"> <a href="tambah_data_staf.php" class="btn btn-primary">Tambah Staf</a> </div>
          <div class="col-sm-6">
              </div>
            </div>
        ...
        <a href="edit_staf.php?id=<?php echo $d['id']; ?>"class = "btn btn-success"><i class="fas fa-edit"></i></a></td>
        <td>
        <a href="hapus_staf.php?id=<?php echo $d['id']; ?>" class = "btn btn-danger" onClick="JavaScript: return confirm('Apakah anda yakin?')"><i class="fas fa-trash"></i></a></td>
       <?php }?>
