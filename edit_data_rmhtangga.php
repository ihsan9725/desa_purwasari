  ...
  <div class="bg-light border-right" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Data Rumah Tangga</h1>
        <p>Edit Data Rumah Tangga Desa Purwasari</p>
      </div>
      <body>
    <!-- Main content -->
...
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_rmhtangga WHERE id='$id'")or die(mysqli_errors());
  ...
  ?>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <form action="update_data_rmhtangga.php" method="post">
                  <label>Foto</label>
                  <input type="hidden" name="id" id="id" value="<?php echo $d['id']?>">
                  <img src="img/<?php echo $d['foto']?>" width="50dp" height="50dp">
                </div>

                <!-- /.form-group -->
                <div class="form-group">
                  <label>Kepala Rumah Tangga</label>
                  <input type="Text" name="kpl_rmhtangga" id="" class="form-control" value="<?php echo $d['kpl_rmhtangga']?>">
                </div>
                <!-- /.form-group -->
                 <!-- /.form-group -->
                <div class="form-group">
