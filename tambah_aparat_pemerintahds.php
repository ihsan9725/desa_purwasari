        ...
        <div class="card-body">
          <div class="card card-success">
            <div class="card-header">
              <h4 class="card-title">Tambah Data Staf Pemerintah Desa</h4>
            ...
            <div class="card-body">
              ...
              <form action="tambah_aksi_aparat_pemerintahds.php" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group">
                ...
                <input type="text" name="nama_peg" id="nama_peg" class="form-control" rows="" placeholder="">     
              </div>
               <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="nipd" id="nipd" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">NIP</label>
                <input type="text" name="nip" id="nip" class="form-control" rows="" placeholder="">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="pendidikan" id="pendidikan" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">Agama</label>
                <input type="text" name="agama" id="agama" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">Pangkat/Gol</label>
                <input type="text" name="pangkat" id="pangkat" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">No SK Pengangkatan</label>
                <input type="text" name="no_sk_pengangkatan" id="no_sk_pengangkatan" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">Tgl SK Pengangkatan</label>
                <input type="date" name="tgl_sk_pengangkatan" id="tgl_sk_pengangkatan" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">No SK Pemberhentian</label>
                <input type="text" name="no_sk_pemberhentian" id="no_sk_pemberhentian" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">Tgl SK Pemberhentian</label>
                <input type="date" name="tgl_sk_pemberhentian" id="tgl_sk_pemberhentian" class="form-control" rows=""> 
              </div>
              <div class="form-group">
                <label for="inputDescription">Masa Jabatan (Usia/Periode)</label>
                <input type="text" name="masa_jabatan" id="masa_jabatan" class="form-control" rows=""> 
              </div>
               <div class="form-group">
                <label for="inputDescription">Jabatan</label>
                <input type="text" name="jabatan" id="jabatan" class="form-control" rows=""> 
              </div>
               <div class="form-group">
