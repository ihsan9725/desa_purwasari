 ...
 <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>Jenis Pelayanan Kantor Desa Mandalahaji</p>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title m-0">Edit Jenis Pelayanan</h5>
              </div>
              <div class="card-body">
...
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_layanan WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query_mysqli)){
  ?>
               <form action="update_pelayanan.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label for="inputDescription">Jenis Layanan</label>
                <input type="text" name="jenis_layanan" id="inputDescription" class="form-control" rows="" placeholder="Jenis Layanan" value="<?php echo $d['jenis_layanan']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Deskripsi</label>
                <input type="text" name="deskripsi" id="inputDescription" class="form-control" rows="" placeholder="Masukkan Deskripsi" value="<?php echo $d['deskripsi']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Pragraf 1</label>
                <input type="text" name="pra1" id="inputDescription" class="form-control" rows="" placeholder="Masukkan Pragraf 1" value="<?php echo $d['pra1']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 2</label>
                <input type="text" name="pra2" id="inputDescription" class="form-control" rows="" placeholder="Masukkan Pragraf 2" value="<?php echo $d['pra2']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Pragraf 3</label>
                <input type="text" name="pra3" id="inputDescription" class="form-control" rows="" placeholder="Masukkan Pragraf 3" value="<?php echo $d['pra3']?>">
              </div>
              <div class="card-body"></div>
              <button type="submit" class="btn btn-success" value="validasi.php" name="simpan">Simpan</button>
               <a href="pelayanan.php" class="btn btn-warning btn-md" >Beranda</a>
            </div>
