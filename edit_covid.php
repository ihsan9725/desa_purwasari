  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-3">Edit Pemudik Covid-19</h1>
        <p><h4>Halaman Edit Data Pemudik</h4></p>
      </div>
      <body>
          ...
          <div class="card card-primary">
           ...
           <div class="card-body">
              <!-- tampilkan nama foto di form ganti bg -->
               <form action="update_covid.php" method="post" enctype="multipart/form-data">
...
include "koneksi.php";
$id = $_GET['id'];
$query_mysqli = mysqli_query($koneksi, "SELECT * FROM tb_covid WHERE id='$id'")or die(mysqli_errors());
while($d = mysqli_fetch_array($query_mysqli)){
  ?>
               <div class="form-group">
                <label for="inputDescription">Nama</label>
                <input type="hidden" name="id" value="<?php echo $d['id']?>">
                <input type="text" name="nama" id="nama" class="form-control" rows="" value="<?php echo $d['nama']?>">     
              </div>
               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="kk" id="kk" class="form-control" rows="" value="<?php echo $d['kk']?>">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Kepala Keluarga</label>
                <input type="text" name="ayah" id="ayah" class="form-control" rows="" value="<?php echo $d['ayah']?>">     
              </div>
              <div class="form-group">
                ...
                <input type="text " name="tgl_lahir" id="tgl_lahir" class="form-control" rows="" value="<?php echo $d['tgl_lahir']?>">
                <input type="text " name="umur" id="umur" class="form-control" rows="" value="<?php echo $d['umur']?>">   
              </div>
              <div class="form-group">
                <label for="inputDescription">Alamat</label>
                <input type="text" name="alamat" id="alamat" class="form-control" rows="" value="<?php echo $d['alamat']?>">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Status</label>
                <input type="text" name="status_perkawinan" id="status_perkawinan" class="form-control" rows="" value="<?php echo $d['status_perkawinan']?>">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Pekerjaan</label>
                <input type="text" name="pekerjaan" id="pekerjaan" class="form-control" rows="" value="<?php echo $d['pekerjaan']?>">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Pendidikan/Warga Negara/Agama</label>
                <input type="text " name="pendidikan_ditempuh" id="pendidikan_ditempuh" class="form-control" rows="" value="<?php echo $d['pendidikan_ditempuh']?>">
                <input type="text " name="warga" id="warga" class="form-control" rows="" value="<?php echo $d['warga']?>">
              ...
              <div class="form-group">
                ...
                <input type="text" name="jenis_kelamin" id="jenis_kelamin" class="form-control" rows="" value="<?php echo $d['jenis_kelamin']?>">     
              </div>
               <div class="form-group">
                <label for="inputDescription">Asal Pemudik (Kota)/Tiba Tinggal</label>
                <input type="text" name="kota" id="" class="form-control" rows="" value="<?php echo $d['kota']?>">
                <input type="date" name="tgl_tiba" id="" class="form-control" rows="" value="<?php echo $d['tgl_tiba']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Tujuan Mudik/Durasi Mudik</label>
                <select class="form-control" name="tujuan" id="tujuan">
                <option selected="selected" ><?php echo $d['tujuan']?></option>
                <option>LIBURAN</option>
                <option>MENJENGUK KELUARGA</option>
                <option>PULANG KAMPUNG</option>
                <option>DLL</option>
                </select> 
                <input type="text" name="jml_hari" id="jml_hari" class="form-control" rows="" placeholder="Jumlah Hari(angka)" value="<?php echo $d['jml_hari']?>">
              </div>
               <div class="form-group">
                <label for="inputDescription">Kontak Pemudik (HP/Email)</label>
                <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="No HP" value="<?php echo $d['no_hp']?>">
                <input type="text" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo $d['email']?>">
              </div>
              <div class="form-group">
                <label for="inputDescription">Apakah Wajib Dipantau</label>
                <select class="form-control" name="wajib_pantau">
                  <option selected="selected"><?php echo $d['wajib_pantau']?></option>
                  <option>YA</option>
                  <option>TIDAK</option>
                </select>
              </div>
             ...
             <div class="form-group">
               ...
               <input type="text" name="keluhan_kesehatan" placeholder="Keluhan Kesehatan" class="form-control" value="<?php echo $d['keluhan_kesehatan']?>">
             </div>
             <div class="form-group">
               <label for="inputDescription">Keterangan</label>
               <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" value="<?php echo $d['keterangan']?>">
             </div>
