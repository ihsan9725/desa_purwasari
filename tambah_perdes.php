        ...
        <div class="card-body">
          <div class="card card-success">
            ...
            <div class="card-body">
              ...
              <form action="tambah_aksi_perdes.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="jenis_per" id="jenis_per">
                  <option selected="selected">Pilih Jenis Peraturan</option>
               ...
               <div class="form-group">
                ...
                <input type="text" name="no_ditetapkan" id="no_ditetapkan" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Ditetapkan</label>
                <input type="date" name="tgl_ditetapkan" id="tgl_ditetapkan" class="form-control" rows="" placeholder="">
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Kesepakatan</label>
                <input type="date" name="tgl_kesepakatan" id="tgl_kesepakatan" class="form-control" rows="" placeholder="">
              </div>
              <div class="form-group">
                <label for="inputDescription">No Dilaporkan</label>
                <input type="text" name="no_dilaporkan" id="no_dilaporkan" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="text" name="lembaran_desa" id="lembaran_desa" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Diundangkan dalam Lembaran Desa</label>
                <input type="date" name="tgl_dlm_lembaran" id="tgl_dlm_lembaran" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">No Diundangkan dalam Berita Desa</label>
                <input type="text" name="berita_desa" id="berita_desa" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Tanggal Diundangkan dalam Berita Desa</label>
                <input type="date" name="tgl_berita_desa" id="tgl_berita_desa" class="form-control" rows="" placeholder="">     
              </div>
              <div class="form-group">
                <label for="inputDescription">Keterangan</label>
                <input type="text" name="keterangan" id="keterangan" class="form-control" rows="" placeholder="">     
              </div>
